    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between h-full">
        <div>
            ...
            <nav class="p-4 space-y-1">
                <a href="#" class="flex items-center px-4 py-2.5 bg-blue-600 text-white rounded-lg font-semibold text-sm transition">
    ...
    <main class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 shrink-0">
            ...
            <div class="relative w-96">
                ...
                <input type="text" placeholder="Cari pesanan, SKU, atau pelanggan..." class="w-full bg-gray-50 text-sm border-none rounded-full pl-10 pr-4 py-2 focus:ring-2 focus:ring-blue-100 outline-none transition">
            </div>
